  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full border-b border-black bg-sidebar shrink-0 z-[999] overflow-visible flex flex-col">
      <div className="w-full h-[40px] grid grid-cols-[auto_1fr_auto] items-center px-4 relative">
        ...
        {/* Icons - Centered */}
        <div className="flex items-center justify-center gap-[6px] sm:gap-[10px] md:gap-[22px] overflow-hidden">
          {/* Reminders */}
          <Link 
            href={{ pathname: "/reminders" }}
            className="group relative flex items-center justify-center w-8 h-8 rounded-md transition-colors text-black/60 hover:bg-black/5 hover:text-black focus:outline-none shrink-0"
          >
          ...
          <button 
            ...
            className="group relative flex items-center justify-center w-8 h-8 rounded-md transition-colors text-black/60 hover:bg-black/5 hover:text-black focus:outline-none shrink-0 bg-transparent border-none p-0"
          >
