...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between h-[60px] px-4 border-b border-gray-100 bg-white shrink-0 sticky top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        {/* Settings Wrench */}
        <button 
          className="w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-gray-50 rounded-md transition-colors group relative"
          aria-label="Settings"
        >
        ...
        {/* Credentials */}
        <div className="group relative w-8 h-8 flex items-center justify-center rounded-md hover:bg-gray-50 cursor-pointer transition-colors">
        ...
        <button 
          ...
          className="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-red-600 hover:bg-gray-50 rounded-md transition-colors group relative"
          aria-label="Log out"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
