  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full border-b border-black bg-sidebar shrink-0 z-[999] overflow-visible flex flex-col">
      <div className="w-full h-[40px] flex items-center px-4 relative">
        {/* Logo - Left aligned */}
        <Link href="/" className="text-2xl font-bold text-[#5A45E8] tracking-tight hover:opacity-80 transition-opacity no-underline shrink-0 z-20">
          parq
        </Link>
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
          <div className="flex items-center justify-center gap-[14px] md:gap-[22px] pointer-events-auto translate-x-[38px]">
            ...
            <Link 
              ...
              className="group relative flex items-center justify-center w-8 h-8 md:w-9 md:h-9 rounded-md transition-colors text-black/60 hover:bg-black/5 hover:text-black focus:outline-none"
            >
            ...
            <button 
              ...
              className="group relative flex items-center justify-center w-8 h-8 md:w-9 md:h-9 rounded-md transition-colors text-black/60 hover:bg-black/5 hover:text-black focus:outline-none shrink-0 bg-transparent border-none p-0"
            >
