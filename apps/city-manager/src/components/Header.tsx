        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
          <div className="flex items-center justify-center gap-[14px] md:gap-[22px] pointer-events-auto translate-x-[38px]">
            ...
            >
              ...
              <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('reminders')}</span>
            </Link>
            ...
            >
              ...
              <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('browser')}</span>
            </Link>
            ...
            >
              ...
              <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('resources')}</span>
            </Link>
            ...
            >
              ...
              <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('settings')}</span>
            </Link>
