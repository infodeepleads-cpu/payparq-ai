...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full flex items-center h-[60px] pl-1 pr-7 md:px-2 border-b border-gray-100 bg-sidebar shrink-0 z-50">
        {/* Logo */}
      ...
      <div className="flex items-center gap-0 md:gap-2">
        ...
        <button 
          ...
          className="group relative flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-md transition-colors text-gray-600 hover:bg-gray-100 hover:text-black focus:outline-none bg-transparent border-none ring-0 shadow-none shrink-0"
        >
