                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex flex-col items-start">
                          ...
                          <div className="flex items-center space-x-2">
                            <span className={`text-[11px] font-bold h-[18px] flex items-center px-1.5 rounded-md ${isSelected ? 'bg-white/10 text-white' : 'bg-black/5 text-black'}`}>
              ...
              <div className="mt-auto pt-4 border-t-2 border-black space-y-4">
                ...
                <div className="flex items-center space-x-2 mb-[calc(1cm+0.2cm)]">
                  ...
                  >
                    ...
                    <span className="text-[16px] font-black tracking-widest relative z-10">Odaberi {RIDE_CLASSES[selectedClass].label}</span>
                  ...
                  <button className="w-14 h-14 bg-black rounded-full flex items-center justify-center shrink-0 shadow-lg active:scale-95 transition-all">
                    <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
