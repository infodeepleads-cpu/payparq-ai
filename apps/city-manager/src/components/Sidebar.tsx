    ...
    <aside className="hidden md:flex flex-col w-[280px] h-full bg-sidebar border-r border-gray-100 text-sidebarText text-sm pt-4 pb-4">
      ...
      <nav className="flex-1 px-3 space-y-1 overflow-y-auto scrollbar-hide">
        ...
        <div className="pb-4 pt-2">
          <a href="/" className={`flex items-center gap-2 px-3 py-2 rounded-md ${!pathname.includes('inbox') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>
            <span>Chat</span>
          </a>
          <a href="/inbox" className={`flex items-center gap-2 px-3 py-2 rounded-md ${pathname.includes('inbox') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
