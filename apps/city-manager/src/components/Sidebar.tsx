    ...
    <>
      ...
      <aside className="hidden md:flex flex-col h-full bg-white border-r border-gray-100 text-black fixed left-0 top-[60px] bottom-0 z-40 w-[60px] pt-2">
        ...
        <div className="px-2 py-2 space-y-2 overflow-visible border-b border-gray-100">
          ...
          <Link href={{ pathname: "/inbox" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('inbox') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
          ...
          <Link href={{ pathname: "/mission" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('mission') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
          ...
          <Link href={{ pathname: "/espresso" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('espresso') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
          ...
          <Link href={{ pathname: "/daily-recap" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('daily-recap') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
          ...
          <Link href={{ pathname: "/crm" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('crm') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
          ...
          <Link href={{ pathname: "/resources" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('resources') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
          ...
          <Link href={{ pathname: "/browser" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('browser') ? 'bg-gray-100 text-black' : 'text-gray-600 hover:bg-gray-50'}`}>
