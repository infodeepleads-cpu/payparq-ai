  ...
  return (
    <>
      {/* Removed spacer to prevent horizontal overflow; layout now uses padding on content container */}
       <aside className="fixed left-0 top-[40px] bottom-0 w-[40px] bg-sidebar border-r border-gray-100 flex flex-col items-center py-4 z-[100]">
        ...
        <div className="px-2 py-2 space-y-3 overflow-visible border-b border-gray-100">
          ...
          <div>
            <Link href={{ pathname: "/" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname === '/' ? 'text-black' : 'text-gray-600 hover:text-black'}`}>
              ...
              <span className="absolute left-full ml-3 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('chat')}</span>
            </Link>
          </div>
          ...
          <Link href={{ pathname: "/inbox" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('inbox') ? 'text-black' : 'text-gray-600 hover:text-black'}`}>
            ...
            <span className="absolute left-full ml-3 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('inbox')}</span>
          </Link>
          ...
          <Link href={{ pathname: "/espresso" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('espresso') ? 'text-black' : 'text-gray-600 hover:text-black'}`}>
            ...
            <span className="absolute left-full ml-3 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('espresso')}</span>
          </Link>
          <Link href={{ pathname: "/daily-recap" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('daily-recap') ? 'text-black' : 'text-gray-600 hover:text-black'}`}>
            ...
            <span className="absolute left-full ml-3 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('daily_recap')}</span>
          </Link>
          <Link href={{ pathname: "/crm" }} className={`group relative flex items-center justify-center p-2 rounded-md transition-colors ${pathname.includes('crm') ? 'text-black' : 'text-gray-600 hover:text-black'}`}>
            ...
            <span className="absolute left-full ml-3 px-2 py-1 bg-white border border-gray-100 text-gray-600 text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50 pointer-events-none shadow-sm">{t('crm')}</span>
          </Link>
        </div>
