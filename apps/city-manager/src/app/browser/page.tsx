  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-200 shadow-sm sticky top-0 z-10">
        ...
        {/* Address Bar */}
        <form onSubmit={handleSubmit} className="flex-1 max-w-3xl mx-auto relative group min-w-0">
          ...
          <input
            ...
            className="block w-full pl-10 pr-10 py-2.5 text-sm bg-gray-100 border-transparent rounded-full focus:bg-white focus:border-gray-300 focus:ring-2 focus:ring-gray-100 focus:outline-none transition-all font-medium text-gray-700 placeholder-gray-400 shadow-inner"
            placeholder="Search or enter website name"
          />
          <div className="absolute inset-y-0 right-0 pr-1 flex items-center">
             <button type="submit" className="p-2 text-gray-400 hover:text-black hover:bg-gray-200 rounded-full transition-all">
