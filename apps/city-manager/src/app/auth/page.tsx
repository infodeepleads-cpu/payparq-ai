          ...
          <div className="bg-[#1A1A1A] border border-white/10 w-full max-w-2xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
            <div className="p-6 border-b border-white/10 flex justify-between items-center bg-[#242424] rounded-t-2xl">
              ...
              <button 
                ...
                className="h-9 w-9 flex items-center justify-center rounded-full bg-transparent border-0 shadow-none outline-none focus:outline-none focus:ring-0 text-white/50 hover:text-white hover:bg-white/5 transition-colors appearance-none"
              >
              ...
              {role === "2" ? (
                <>
                  <section className="space-y-2">
                    <p>
                      Ako želite znati više, posjetite nas na{" "}
                      <a
                        href="https://www.payparq.com"
                        target="_blank"
