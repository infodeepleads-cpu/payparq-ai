    ...
    <main className="min-h-[100dvh] w-full bg-black text-white selection:bg-[#7C3AED]/30 overflow-x-hidden relative flex flex-col items-center">
      ...
      <div className="w-full max-w-[430px] px-6 pb-2 -mt-[180px] relative z-[60] flex flex-col">
        ...
        <div className="flex items-center justify-between mb-10 h-11 relative">
          ...
          >
            <span className="text-[13px] font-semibold text-white/70 group-hover:text-white transition-colors truncate max-w-[120px]">
              {user ? (user.email?.split("@")[0] || "Profil") : "Prijava"}
            </span>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-12 gap-4 pb-2 relative pointer-events-auto -mt-4">
          ...
          <Link 
            ...
            className={`${isLimitedRole ? 'col-span-12' : 'col-span-8'} h-[160px] rounded-[32px] bg-[#7C3AED] p-6 flex flex-col justify-between shadow-2xl relative overflow-hidden group active:scale-[0.98] transition-transform cursor-pointer no-underline`}
          >
