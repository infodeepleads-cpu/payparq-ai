...
const localHrOverrides = new Map<string, string>([
  ...
  ["Start earning money as a Payparq host", "Počnite zarađivati kao Payparq domaćin"],
  ["Turn your private parking spot into passive income. Go live in 60 minutes.", "Pretvorite svoje privatno parkirno mjesto u izvor pasivnog prihoda. Objavite oglas već danas — potrebno je manje od 60 minuta."],
  ["100% free to list", "100% besplatno oglašavanje"],
  ["Verified drivers and vehicles", "Provjereni vozači i vozila"],
  ["Set your own prices", "Sami određujete cijenu"],
  ["List your parking space", "Objavite svoje parkirno mjesto"],
  ["Join thousands other space owners.", "Pridružite se tisućama vlasnika prostora."],
  ["List today and start earning hundreds from your unused parking spaces", "Objavite danas i počnite ostvarivati dodatni prihod od svojih neiskorištenih parkirnih mjesta."],
  ["List your space form", "Obrazac za oglašavanje prostora"],
  ...
  ["Calculate earnings", "Kalkulator zarade"],
  ["Spaces", "Broj mjesta"],
  ...
  ["Create your listing", "Kreirajte oglas"],
  ["Add your space details, set your price, and upload photos in minutes.", "Unesite podatke o svom parkirnom mjestu, postavite cijenu i dodajte fotografije — sve u nekoliko minuta."],
  ["Drivers book and park", "Vozači rezerviraju i parkiraju"],
  ["Verified drivers find and book your space. You get notified instantly.", "Provjereni vozači pronalaze i rezerviraju vaše mjesto. Obavijest dobivate odmah."],
  ["You get paid", "Primate uplatu"],
  ["Earnings land in your account automatically. No chasing required.", "Zarada vam se automatski isplaćuje na račun — bez dodatnog angažmana."],
  ["Payment", "Plaćanje"],
  ["How do I get paid?", "Kako će se plaćati?"],
  ["When do I get paid?", "Kada ću dobiti isplatu?"],
  ["What if I haven’t added a payment preference?", "Što ako nisam dodao postavke plaćanja?"],
  ["What payment methods are accepted?", "Koji su načini plaćanja prihvaćeni?"],
  ["Are there any fees?", "Postoje li naknade?"],
  ["Can I withdraw my earnings early?", "Mogu li prijevremeno podići svoju zaradu?"],
  ["How do I track my earnings?", "Kako mogu pratiti svoju zaradu?"],
  ["What if there’s a dispute with a driver?", "Što ako dođe do spora s vozačem?"],
  ["Is my money safe?", "Je li moj novac siguran?"],
  ["Yes. All funds are held securely and transferred to your registered payment method on schedule. We use industry-standard encryption.", "Da. Sva sredstva su sigurno pohranjena i isplaćuju se prema rasporedu na vaš odabrani način plaćanja. Koristimo standardne metode enkripcije za zaštitu podataka."],
