...
export const NEARBY_PLACES: Record<string, NearbyPlace[]> = {
  split: [
    { name: 'Marjan Park', distance: 11.2, lat: 43.5167, lng: 16.4333, type: 'Park', image: 'https://images.unsplash.com/photo-1469022563149-aa64dbd37dae?w=400&h=300&fit=crop&auto=format&q=80' },
  ...
  zadar: [
    { name: 'Zadar Old Town', distance: 9.4, lat: 44.1149, lng: 15.2298, type: 'City Center', image: 'https://images.unsplash.com/photo-1493857671505-72967e2e2760?w=400&h=300&fit=crop&auto=format&q=80' },
  ...
  zagreb: [
    { name: 'Ban Jelačić Square', distance: 10.5, lat: 45.8150, lng: 15.9819, type: 'City Center', image: 'https://images.unsplash.com/photo-1493857671505-72967e2e2760?w=400&h=300&fit=crop&auto=format&q=80' },
  ...
  dubrovnik: [
    { name: 'Dubrovnik Old Town', distance: 15.8, lat: 42.6416, lng: 18.1087, type: 'City Center', image: 'https://images.unsplash.com/photo-1493857671505-72967e2e2760?w=400&h=300&fit=crop&auto=format&q=80' },
