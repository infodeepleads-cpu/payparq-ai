        ...
        <section className="max-w-6xl mx-auto px-6 md:px-12 py-16 md:py-20">
          <div className="max-w-2xl">
            ...
            <p className="text-sm md:text-base text-black/75">
              We are assembling a small, focused team across product, engineering, and operations to
              reinvent how parking portfolios are managed. If you are excited about mobility, data, and
              infrastructure, Payparq is the place to build.
            </p>
          </div>
        </section>
      </main>
