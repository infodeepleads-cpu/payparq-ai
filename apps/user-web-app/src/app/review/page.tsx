...
const OPTIONS = [
  ...
  { value: 7.5,  emoji: '🙂', label: 'Dobro',       color: '#5F3DFC' },
  { value: 10,   emoji: '😄', label: 'Izvrsno',     color: '#4caf50' },
];
  ...
  if (done) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white text-center px-6">
        ...
        <a href="/" className="px-8 py-3 bg-white text-black font-bold rounded-lg text-sm hover:bg-white/90 transition-colors">
          Povratak na PayParq
        </a>
      </div>
    );
