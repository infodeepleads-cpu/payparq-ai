            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
              <div className="flex flex-col justify-center">
                ...
                <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-black mb-4 break-words">
                  Parkiraj kod Aerodroma Split
                </h1>

                {/* Description */}
                <p className="text-base text-black/70 mb-8 leading-relaxed">
                  Pronađite parking blizu Aerodroma Split sa 100+ dostupnih mjesta za rezervaciju. Pomoći ćemo vam osigurati mjesto na najboljim cijenama. Rezervirajte u 2 minute sa trenutnom potvrdom.
                </p>
