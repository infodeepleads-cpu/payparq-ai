    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 pt-24 md:pt-28">
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-12 py-16 border-b border-black/10">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-black mb-1">Guaranteed Parking Spot</h3>
                <p className="text-sm text-black/60">Your space is reserved and waiting. No searching, no disappointment.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <Check size={24} className="text-black flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-black mb-1">Book in 2 Minutes</h3>
                <p className="text-sm text-black/60">Fast, simple booking process with instant confirmation.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <Check size={24} className="text-black flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-black mb-1">Save Up to 70%</h3>
                <p className="text-sm text-black/60">Much cheaper than airport parking with guaranteed quality.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-12 py-16 border-b border-black/10">
          ...
          <div className="space-y-6">
            {[
              { num: 1, title: 'Enter Your Dates', desc: 'Tell us when you need parking at Split Airport' },
              ...
              <div key={step.num} className="flex gap-4">
                <div className="bg-black text-white rounded-full w-10 h-10 flex items-center justify-center flex-shrink-0 text-sm font-semibold">
                  {step.num}
                </div>
                <div>
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-12 py-16 border-b border-black/10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              <p className="text-3xl font-semibold text-black">365</p>
              <p className="text-sm text-black/60 mt-2">Days of customer support available</p>
            </div>
            <div>
              <p className="text-3xl font-semibold text-black">100%</p>
              <p className="text-sm text-black/60 mt-2">Satisfaction guaranteed or full refund</p>
            </div>
          </div>
        </section>
