...
interface SplitAirportClientProps {
  airport: Airport;
}
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto pt-24 md:pt-28">
        ...
        {/* Reviews Section */}
        <AirportReviews airport="split" locationName={airport.name} />

        {/* Parking Lots Section */}
        <AirportParkingLots airport="split" lat={airport.lat} lng={airport.lng} airportName={airport.name} />
