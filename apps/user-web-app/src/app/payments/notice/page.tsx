...
function NoticeContent() {
  ...
  return (
    <div style={{ fontFamily: "'Arial', 'Helvetica', sans-serif", color: "#000", background: "#fff", maxWidth: "794px", margin: "0 auto", padding: "40px 48px", minHeight: "100vh" }}>
      ...
      <div style={{ breakBefore: "page", pageBreakBefore: "always", paddingTop: "8px", fontFamily: "Arial, Helvetica, sans-serif" }}>

        {/* Title */}
        <div style={{ textAlign: "right", color: "#cc2200", fontWeight: 700, fontSize: "13px", letterSpacing: "0.5px", marginBottom: "4px", textTransform: "uppercase" }}>
          Nalog za nacionalna plaćanja
        </div>

        {/* Outer border */}
        <div style={{ border: "2px solid #cc2200", fontSize: "10px", color: "#000" }}>

          {/* ROW 1 — Platitelj (left, spans rows 1-3) + Hitno/Valuta/Iznos (right) */}
          <div style={{ display: "grid", gridTemplateColumns: "200px 1fr", borderBottom: "1px solid #cc2200" }}>

            {/* Platitelj cell — spans 3 sub-rows via rowspan trick: just one tall cell */}
            <div style={{ borderRight: "1px solid #cc2200", padding: "4px 6px", display: "flex", flexDirection: "column", justifyContent: "flex-start" }}>
              <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700, marginBottom: "3px" }}>PLATITELJ (naziv/ime i adresa):</div>
              <div style={{ borderBottom: "1px solid #cc2200", minHeight: "16px", marginBottom: "3px", fontSize: "9px", color: "#888" }}>Vaše ime i prezime</div>
              <div style={{ borderBottom: "1px solid #cc2200", minHeight: "16px", marginBottom: "3px", fontSize: "9px", color: "#888" }}>Adresa,</div>
              <div style={{ minHeight: "16px", fontSize: "9px", color: "#888" }}>Poštanski broj i Grad</div>
            </div>

            {/* Right column — stacked sub-rows */}
            <div style={{ display: "flex", flexDirection: "column" }}>

              {/* Hitno + Valuta + Iznos */}
              <div style={{ display: "grid", gridTemplateColumns: "60px 100px 1fr", borderBottom: "1px solid #cc2200", minHeight: "28px" }}>
                <div style={{ borderRight: "1px solid #cc2200", padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Hitno:</div>
                  <div style={{ border: "1px solid #cc2200", width: "14px", height: "14px", marginTop: "2px" }}></div>
                </div>
                <div style={{ borderRight: "1px solid #cc2200", padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Valuta plaćanja:</div>
                  <div style={{ fontWeight: 700, fontSize: "12px", marginTop: "2px" }}>EUR</div>
                </div>
                <div style={{ padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Iznos:</div>
                  <div style={{ display: "flex", alignItems: "center", gap: "4px", marginTop: "2px" }}>
                    <div style={{ border: "1px solid #cc2200", padding: "1px 6px", fontWeight: 700, fontSize: "13px", letterSpacing: "1px", minWidth: "80px", textAlign: "right" }}>{amountDisplay.replace("€","").replace("EUR","").trim()}</div>
                    <span style={{ color: "#cc2200", fontWeight: 700, fontSize: "11px" }}>= EUR</span>
                  </div>
                </div>
              </div>

              {/* IBAN platitelja */}
              <div style={{ borderBottom: "1px solid #cc2200", padding: "3px 5px", minHeight: "26px" }}>
                <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>IBAN ili broj računa platitelja:</div>
                <div style={{ borderBottom: "1px solid #aaa", minHeight: "14px", marginTop: "2px" }}></div>
              </div>

              {/* Model + Poziv platitelja */}
              <div style={{ display: "grid", gridTemplateColumns: "100px 1fr", minHeight: "26px" }}>
                <div style={{ borderRight: "1px solid #cc2200", padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Model:</div>
                  <div style={{ borderBottom: "1px solid #aaa", minHeight: "14px", marginTop: "2px" }}></div>
                </div>
                <div style={{ padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Poziv na broj platitelja:</div>
                  <div style={{ borderBottom: "1px solid #aaa", minHeight: "14px", marginTop: "2px" }}></div>
                </div>
              </div>
            </div>
          ...
          {/* ROW 2 — IBAN primatelja full width */}
          <div style={{ borderBottom: "1px solid #cc2200", padding: "4px 6px", display: "flex", alignItems: "center", gap: "10px", background: "#fff8f8" }}>
            <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700, whiteSpace: "nowrap" }}>IBAN ili broj računa primatelja:</div>
            <div style={{ fontFamily: "monospace", fontWeight: 700, fontSize: "14px", letterSpacing: "1px", color: "#000" }}>{PAYEE_IBAN}</div>
          </div>

          {/* ROW 3 — Primatelj (left) + Model/Poziv/Šifra/Opis/Datum (right) */}
          <div style={{ display: "grid", gridTemplateColumns: "200px 1fr", borderBottom: "1px solid #cc2200" }}>

            {/* Primatelj */}
            <div style={{ borderRight: "1px solid #cc2200", padding: "4px 6px" }}>
              <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700, marginBottom: "3px" }}>PRIMATELJ (naziv/ime i adresa):</div>
              <div style={{ fontWeight: 700, fontSize: "11px", marginBottom: "2px" }}>{PAYEE_NAME}</div>
              <div style={{ fontSize: "10px", marginBottom: "1px" }}>{PAYEE_ADDRESS_1}</div>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              {/* Model primatelja + Poziv primatelja */}
              <div style={{ display: "grid", gridTemplateColumns: "100px 1fr", borderBottom: "1px solid #cc2200", minHeight: "30px" }}>
                <div style={{ borderRight: "1px solid #cc2200", padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Model:</div>
                  <div style={{ fontFamily: "monospace", fontWeight: 700, fontSize: "13px", marginTop: "2px" }}>{PAYEE_MODEL}</div>
                </div>
                <div style={{ padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Poziv na broj primatelja:</div>
                  <div style={{ fontFamily: "monospace", fontWeight: 700, fontSize: "13px", marginTop: "2px" }}>{reference}</div>
                </div>
              </div>

              {/* Šifra namjene + Opis plaćanja */}
              <div style={{ display: "grid", gridTemplateColumns: "100px 1fr", borderBottom: "1px solid #cc2200", minHeight: "28px" }}>
                <div style={{ borderRight: "1px solid #cc2200", padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Šifra namjene:</div>
                  <div style={{ borderBottom: "1px solid #aaa", minHeight: "14px", marginTop: "2px" }}></div>
                </div>
                <div style={{ padding: "3px 5px" }}>
                  <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Opis plaćanja:</div>
                  <div style={{ fontSize: "10px", marginTop: "2px" }}>{PAYEE_DESCRIPTION}</div>
                </div>
              </div>

              {/* Datum izvršenja */}
              <div style={{ padding: "3px 5px", minHeight: "24px" }}>
                <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Datum izvršenja:</div>
                <div style={{ borderBottom: "1px solid #aaa", minHeight: "14px", marginTop: "2px" }}></div>
              </div>
            </div>
          </div>

          {/* ROW 4 — QR + Pečat + Potpis */}
          <div style={{ display: "grid", gridTemplateColumns: "160px 1fr 1fr" }}>

            {/* QR + Obr. HUB 3A label */}
            <div style={{ borderRight: "1px solid #cc2200", padding: "8px", display: "flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
              <QRCanvas text={hub3aText} size={120} />
              <div style={{ fontSize: "8px", color: "#cc2200", fontWeight: 700, letterSpacing: "0.5px" }}>Obr. HUB 3A</div>
            </div>

            {/* Pečat */}
            <div style={{ borderRight: "1px solid #cc2200", padding: "6px 8px", minHeight: "80px" }}>
              <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Pečat korisnika PU</div>
            </div>

            {/* Potpis */}
            <div style={{ padding: "6px 8px" }}>
              <div style={{ color: "#cc2200", fontSize: "8px", fontWeight: 700 }}>Potpis korisnika PU</div>
            </div>
          </div>
