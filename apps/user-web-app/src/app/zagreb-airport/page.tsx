            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
              <div className="flex flex-col justify-center">
                <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-black mb-4 break-words">
                  Reserve Parking at Zagreb Airport
                </h1>
                <p className="text-base text-black/70 mb-8 leading-relaxed">
                  Find parking near Zagreb Airport with 100+ reservable spaces available. We'll help you secure a space at the best priced parking. Book in 2 minutes with instant confirmation.
                </p>
