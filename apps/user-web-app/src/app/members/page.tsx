...
export default function MembersPage() {
  ...
  const [selectedLotForQuickBook, setSelectedLotForQuickBook] = useState<string | null>(null);
                  ...
                  >
                    ...
                    {loc.verification_status === 'verified' && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setSelectedLotForQuickBook(loc.id);
                          setArrivalDateTime('');
    ...
    >
      ...
      {showArrivalPicker && (
        <div className="fixed inset-0 bg-black/50 flex items-end md:items-center justify-center z-50">
          <div className="bg-white w-full md:w-96 rounded-t-2xl md:rounded-2xl p-6 space-y-4">
            <h2 className="text-lg font-bold">Select Arrival Date & Time</h2>
            <div className="space-y-3">
              <div>
            ...
            <div className="flex gap-2 pt-4">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-black text-white rounded-lg text-sm font-semibold hover:bg-gray-800 disabled:opacity-50"
      ...
      {showDeparturePicker && (
        <div className="fixed inset-0 bg-black/50 flex items-end md:items-center justify-center z-50">
          <div className="bg-white w-full md:w-96 rounded-t-2xl md:rounded-2xl p-6 space-y-4">
            <h2 className="text-lg font-bold">Select Departure Date & Time</h2>
            <div className="space-y-3">
              <div>
                <label className="text-sm font-semibold text-gray-700 block mb-1">Date</label>
                <input
            ...
            <div className="flex gap-2 pt-4">
              ...
              <button
                onClick={() => {
                  if (departureDateTime && selectedLotForQuickBook) {
                    setShowDeparturePicker(false);
                    router.push(`/members/listing/${selectedLotForQuickBook}?in=${encodeURIComponent(arrivalDateTime)}&out=${encodeURIComponent(departureDateTime)}`);
                  }
                }}
                className="flex-1 px-4 py-2 bg-black text-white rounded-lg text-sm font-semibold hover:bg-gray-800 disabled:opacity-50"
