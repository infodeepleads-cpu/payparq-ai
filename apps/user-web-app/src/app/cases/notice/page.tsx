...
function NoticeContent() {
  ...
  if (notFound || !caseData) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", fontFamily: "sans-serif" }}>
        <p>Notice not found. <a href="/cases" style={{ textDecoration: "underline" }}>Return to Cases</a></p>
      </div>
    );
  }
    ...
    <div style={{ fontFamily: "'Arial', 'Helvetica', sans-serif", color: "#000", background: "#fff", maxWidth: "794px", margin: "0 auto", padding: "40px 48px", minHeight: "100vh" }}>
      ...
      {photos.length > 0 && (
        <div style={{ marginBottom: "20px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: `repeat(${Math.min(photos.length, 2)}, 1fr)`, gap: "12px" }}>
            {photos.map((src, i) => (
              <div key={i} style={{ position: "relative", width: "100%", aspectRatio: "16/9", borderRadius: "8px", overflow: "hidden", border: "1px solid #e5e7eb", background: "#000" }}>
      ...
      <div style={{ borderTop: "1px solid #e5e7eb", paddingTop: "16px", fontSize: "10px", color: "#888", lineHeight: "1.6" }}>
        ...
        <p style={{ marginTop: "6px" }}>
          Za sporove i upite: payparq@outlook.com · payparq.com/cases
        </p>
      </div>
