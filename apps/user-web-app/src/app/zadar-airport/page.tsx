  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto pt-24 md:pt-28">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
              <div className="flex flex-col justify-center">
                ...
                <p className="text-base text-black/70 mb-8 leading-relaxed">
                  {locale === 'hr'
                    ? 'Pronađite parking blizu Aerodroma Zadar sa 60+ rezervabilnih mjesta. Zajamčeno mjesto po najboljoj cijeni. Rezervirajte u 2 minute s trenutnom potvrdom.'
        ...
        <AirportReviews airport="zadar" locationName="Zadar Airport" />

        <AirportParkingLots airport="zadar" lat={44.1083} lng={15.3467} airportName="Zadar Airport" />
        ...
        <WhyPayParq airport="Zadar Airport" />
