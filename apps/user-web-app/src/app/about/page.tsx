        ...
        <section className="max-w-6xl mx-auto px-6 md:px-12 py-16 md:py-20">
          <div className="max-w-2xl">
            ...
            <p className="text-sm md:text-base text-black/75">
              Payparq is building a software-first platform that turns parking portfolios into connected,
              data-driven assets. We focus on Mobile LPR, automation, and operator-friendly tools that
              deliver higher performance with less hardware.
            </p>
          </div>
        </section>
      </main>
