...
const LOCATION_ID = "trogir hub";

export default function TrogirHubPage() {
  return (
      ...
      <main className="flex-1 bg-white pt-24 md:pt-28">
        <section className="max-w-5xl mx-auto px-6 md:px-12 py-12 md:py-16">
          ...
          <p className="text-sm md:text-base text-black/75 mb-6 max-w-2xl">
            Trogir hub serving travellers between Split, the airport, and historic coastal towns. Designed
            for flexible short and long stays.
          </p>
