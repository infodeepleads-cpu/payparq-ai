...
const LOCATION_ID = "brela hub";

export default function BrelaHubPage() {
  return (
      ...
      <main className="flex-1 bg-white pt-24 md:pt-28">
        <section className="max-w-5xl mx-auto px-6 md:px-12 py-12 md:py-16">
          ...
          <p className="text-sm md:text-base text-black/75 mb-6 max-w-2xl">
            Brela hub built for guests staying along the picturesque Riviera, offering simple digital
            access to parking near beaches and villas.
          </p>
