  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto pt-24 md:pt-28">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
              <div className="flex flex-col justify-center">
                <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-black mb-4 break-words">
                  {locale === 'hr' ? 'Parkiraj kod Aerodroma Dubrovnik' : 'Park at Dubrovnik Airport'}
                </h1>
                <p className="text-base text-black/70 mb-8 leading-relaxed">
                  {locale === 'hr'
                    ? 'Pronađite parking blizu Aerodroma Dubrovnik sa 80+ rezervabilnih mjesta. Zajamčeno mjesto po najboljoj cijeni. Rezervirajte u 2 minute s trenutnom potvrdom.'
                    : 'Find parking near Dubrovnik Airport with 80+ reservable spaces. Guaranteed spot at the best price. Book in 2 minutes with instant confirmation.'}
                </p>
                <div className="bg-white border border-black/10 rounded-xl p-6 shadow-sm">
                  <AirportBookingFlow defaultLat={42.5614} defaultLng={18.2682} defaultName="Dubrovnik Airport" />
                </div>
              </div>
        ...
        <AirportReviews airport="dubrovnik" locationName="Dubrovnik Airport" />

        <AirportParkingLots airport="dubrovnik" lat={42.5614} lng={18.2682} airportName="Dubrovnik Airport" />
