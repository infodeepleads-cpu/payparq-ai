    ...
    <div className="min-h-screen bg-white flex flex-col overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto pt-24 md:pt-28">
        <section className="max-w-4xl mx-auto w-full px-6 md:px-12 py-12 md:py-16 border-b border-black/10">
          <div className="mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-black mb-4 break-words">
              Book Your Parking Spot at Dubrovnik Airport
            </h1>
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-12 py-16 border-b border-black/10">
          ...
          <div className="space-y-6">
            [
              { num: 1, title: 'Search', desc: 'Find available parking near Dubrovnik Airport' },
        ...
        <section className="max-w-4xl mx-auto px-6 md:px-12 py-16">
          <div className="border border-black/10 rounded-xl p-8 md:p-12">
            ...
            <p className="text-base text-black/60 mb-6">Save up to 70% on parking at Dubrovnik Airport. Book your guaranteed spot in 2 minutes.</p>
            <div className="flex gap-3 flex-wrap">
              <button onClick={handleBookNow} className="hidden md:inline-flex bg-black text-white font-semibold py-3 px-6 rounded-lg hover:bg-black/90 transition items-center gap-2">
                Book Now <ArrowRight size={18} />
              </button>
